...
const RafflePanel: React.FC<RafflePanelProps> = ({ onRaffleDrawn }) => {
  ...
  const handleCopyToClipboard = () => {
    if (!winner) return;
    const message = `¡Felicidades ${winner.name}! 🥳 Has ganado "${prize}" en el sorteo de Arenal Private Tours by Small Groups. ¡Por favor acércate a nuestro stand para reclamarlo! Gracias por participar.`;
        ...
        <Card className="animate-fade-in">
            ...
            <div className="mt-6">
                ...
                <textarea 
                    ...
                    value={`¡Felicidades ${winner.name}! 🥳 Has ganado "${prize}" en el sorteo de Arenal Private Tours by Small Groups. ¡Por favor acércate a nuestro stand para reclamarlo! Gracias por participar.`}
                />
